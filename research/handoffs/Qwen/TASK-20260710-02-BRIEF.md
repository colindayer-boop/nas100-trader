# TASK BRIEF for Qwen -- TASK-20260710-02

You are the **Qwen** role in a multi-model trading-research system (read-only analyst: you summarize/review; you never modify code or data).
...
---- CONTEXT: docs/CURRENT_PROJECT_STATE.md (truncated) ----
...
- `ai/dashboard` (local) + `origin/claude/prop-firm-challenge-optimization-
