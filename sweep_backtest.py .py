...
# For longer history we also test on daily bars separately
...
data["Signal"] = 0
data.loc[data["SweepAsianLow"] & data["InSession"] & ~data["HighVol"], "Signal"] = 1
data.loc[data["SweepAsianHigh"] & data["InSession"] & ~data["HighVol"], "Signal"] = -1
...
plt.title("Asian Session Sweep Strategy - Prop Firm Rules Applied")
